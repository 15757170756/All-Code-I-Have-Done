...
You may call master.guess(word) to guess a word. 
 The guessed word should have type string and 
...
if you have made 10 or less calls to master.
...
The letters of each word in those testcases 
were chosen independently at random from 'a' to 'z', 
